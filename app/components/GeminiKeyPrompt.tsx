    ...
    <div className="bg-yellow-900/30 border border-yellow-800 rounded-lg p-4 mb-6">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          {isExpanded ? (
            <div className="text-xs space-y-4 text-yellow-200">
              <div className="bg-gray-800 rounded-lg p-3 border border-gray-700">
                <h4 className="font-medium mb-2 text-yellow-100">How to get your Gemini API key:</h4>
                <ol className="list-decimal pl-4 space-y-2">
                  <li>Go to <a href="https://ai.google.dev/" target="_blank" rel="noopener noreferrer" className="text-blue-400 underline">Google AI Studio</a></li>
              ...
              <div className="pt-1 flex justify-end items-baseline">
                <button 
                  ...
                  className="text-xs bg-yellow-800 hover:bg-yellow-700 text-yellow-200 px-3 py-1 rounded-full transition-colors font-medium"
                >
                  Open Settings
                </button>
                <span 
