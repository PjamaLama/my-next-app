  ...
  const plans = [
    {
      ...
      features: [
        { name: '5 messages per day', included: true, icon: MessageSquare },
        { name: 'Basic AI responses', included: true, icon: Zap },
        { name: 'Google Sheets integration', included: true, icon: TrendingUp },
        { name: 'Community support', included: true, icon: Users },
        { name: 'Unlimited spreadsheets', included: false, icon: Crown },
    ...
    },
    {
      ...
      features: [
        { name: 'Unlimited messages', included: true, icon: MessageSquare },
        { name: 'Advanced AI responses', included: true, icon: Zap },
        { name: 'Google Sheets integration', included: true, icon: TrendingUp },
        { name: 'Priority support', included: true, icon: Users },
        { name: 'Unlimited spreadsheets', included: true, icon: Crown },
        { name: 'Custom integrations', included: true, icon: Crown },
        { name: 'Analytics & insights', included: true, icon: Crown },
      ],
